...
/* a packet is the data unit passed from layer 4 (students code) to layer 3*/
/* (teachers code).  Note the pre-defined packet structure, which all   */
...
{
    //encapsulate and do tolayer3(0, pkt)
}
...
{
    pf("  B_timerinterrupt: B doesn't have a timer. ignore.\n");
}
